...
(function($) {
	...
	var defaults = {
		...
		structure: 	 			  '<a href="#" class="prev_button">prev</a>'
								...
								+ '<div class="container_skitter">'
									+ '<div class="image">'
										+ '<a href=""><img name="skitter_main_img" class="image_main" /></a>'
										+ '<div class="label_skitter"></div>'
									+ '</div>'
								+ '</div>',
		//added config for mro
		image_id:				null,
	...
	$sk.fn.extend({
		...
		finishAnimation: function (options) 
		{
			...
			self.settings.afterAnimation(self);
			self.startTime();
		},
		...
		setImageLink: function()
		{
			...
			this.settings.image_id = id_image;
		},
