...
(function()
{
        ...
        {
        	var IMAGE = 1,resized = '', datauri = '',width = 100, height = 100,newimage,
			LINK = 2,
			PREVIEW = 4,
			CLEANUP = 8,
...
//			alert('commitInternally');
		...
		var testResize = function(newwidth,newheight){
			resized ='';
			tempImg = new Image();
			tempImg.src = newimage.src;
...
//				alert(element);
				if(element != null){
					datauri = element.getAttribute('src');
					jQuery('#imagepreview').html('<image id="previewimage" src="'+datauri+'" />');
				}
