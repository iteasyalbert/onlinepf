			...
			<ul class="nav navbar-nav navbar-right">
				<li>
					<a href="https://www.facebook.com/Philippine-Society-of-Pathologists-232421263467403/">
						<?= $this->Html->image('/img/social-facebook.png',array('width' => '20px','class' => 'social-media-logo')) ?>
					</a>
				</li>
				<li>
					<a href="#">
						<?= $this->Html->image('/img/social-gplus.png',array('width' => '20px','class' => 'social-media-logo')) ?>
					</a>
				</li>
				<li>
					<a href="#">
						<?= $this->Html->image('/img/social-linkedin.png',array('width' => '20px','class' => 'social-media-logo')) ?>
					</a>
				</li>
				<li>
					<a href="<?php echo $website['url'];?>#home-services" > <span class="btn exp-link"  style="margin-top:5px;width:auto;">+ BOOK APPOINTMENTS </span> </a>
				</li>
			</ul>
