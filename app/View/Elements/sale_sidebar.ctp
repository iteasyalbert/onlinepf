<div class="sidebar">
  	<div id="Left">
  	    <div class="sidebarmenu">
  	    		<?php echo $this->Html->link('Pending Laboratory Agreements',array('controller'=>'users','action'=>'pending_laboratories'),array('class'=>'menuitem'));?>
  	    		<?php echo $this->Html->link('Pending Coporate Agreements',array('controller'=>'users','action'=>'pending_corporates'),array('class'=>'menuitem'));?>
  	    		<a href="#" class="menuitem submenuheader">Advertisement</a>
				<div class="submenu">
					<ul>
						<li><a><?php echo $this->Html->link('Special Ads',array('controller'=>'advertisements','action'=>'special','sales' => true));?></a></li>
						<li><a><?php echo $this->Html->link('Major Ads',array('controller'=>'advertisements','action'=>'major','sales' => true));?></a></li>
						<li><a><?php echo $this->Html->link('Minor Ads',array('controller'=>'advertisements','action'=>'minor','sales' => true));?></a></li>
					</ul>
				</div>
				<?php echo $this->Html->link('Advertise Message',array('controller'=>'membership','action'=>'sales_advertise_us'),array('class'=>'menuitem'));?>
          </div>
     </div>
</div>
