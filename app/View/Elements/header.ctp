...
<div id="header" style="float:left;">
	<div class="container">
    	...
    	<div class="headr" style="height:220px;">
			...
			<?php if(isset($post['Image'][0]['image']) && !empty($post['Image'][0]['image'])): ?>
	              <img class="shareimg" src="/img/contents/<?php echo $post['Image'][0]['image']?>" style="height: 0px;">
	        <?php endif;?>
	        ...
	        <div style="float:left;">
		        <form action="<?php echo $this->Html->url(array('controller'=>'home','action'=>'search'));?>" method="post" id="searchform">
					<fieldset>
					    ...
					    <input id="s" name="data[Search][input]" type="text" required="required" placeholder="Search our site" class="text_input">
<!--					<input id="s" name="data[Search][input]" type="text" required="required" placeholder="Search our site" class="text_input" onblur="if(this.value==''){this.value='Search our site';}" onfocus="if(this.value =='Search our site') {this.value=''; }">-->
