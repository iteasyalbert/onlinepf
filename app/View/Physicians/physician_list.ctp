<div class="content menu-items-list content-full-width">
	...
	<?php echo $this->element('sidebar_sliding');?>
...
//			debug($filterparams);
		...
		?>
		<?php echo $this->Form->create(NULL,array('url'=>array('controller'=>'Physicians','action'=>'physician_list')));?>
		<h2 style="width: 50px;">Filter</h2>
		<table style="float:right;">
			<tr>
				<td>Province</td>
				<td><?php echo $this->Form->input('Address.province_state_id',array('type'=>'select','title'=>'address_select_1','options'=>$provinces,'empty'=>'','label'=>false,'style'=>'width:150px;','class'=>'address_select','default'=>$defaultProvince));?></td>
				<td>Town/City</td>
				<td><?php echo $this->Form->input('Address.town_city_id',array('type'=>'select','title'=>'address_select_2','options'=>array(),'empty'=>'','label'=>false,'style'=>'width:150px;','class'=>'address_select','default'=>$defaultTown));?></td>
				<td>Barangay</td>
				<td><?php echo $this->Form->input('Address.village_id',array('type'=>'select','title'=>'address_select_3','options'=>array(),'empty'=>'','label'=>false,'style'=>'width:150px;','class'=>'address_select','default'=>$defaultVillage));?></td>
			</tr>
