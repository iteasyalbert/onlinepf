	           ...
	           <div id="patient-container" >
				...
				<tr>
					<td style="vertical-align: top;    padding-top: 2px;">
						<!-- <div id="main-tab" class="widget-result"> -->
							<div id="patientsearch-ouput" class="tabdiv" style="border:1px solid #EC7D7D; padding: 0px; margin-top: 0px !important;">
...
<script>
	...
	jQuery(document).ready(function(){
    	...
    	jQuery('#patientsearch-ouput').css({'height':jQuery('#result').height()-2});
