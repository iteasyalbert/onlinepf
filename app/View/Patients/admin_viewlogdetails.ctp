<div>
	...
	<div id="view">
		...
		<table id="common-tbl" class="visits_tbl" >
			<thead>
				<th style="width:20%;"><?php echo $this->Paginator->sort('datetime', 'Date and Time'); ?></th>
				...
				<th style="width:20%;"><?php echo $this->Paginator->sort('remarks', 'User Details'); ?></th>
				<th style="width:15%;"><?php echo $this->Paginator->sort('device', 'Device'); ?></th>
				<th style="width:25%;"><?php echo $this->Paginator->sort('browser', 'Browser'); ?></th>
				
			</thead>
			<tbody>
			<?php foreach ($auditlogslogin as $auditlog):?>
				<tr>
