...
<script src="/js/angularjs/controllers/patients.controller.js"></script>
<script src="/js/angularjs/services/anchor.service.js"></script>
<script src="/js/angularjs/services/getRecord.service.js"></script>
