...
<div class="content">
	<img src="/img/wizard_laboratory_confirm.png" style="margin-bottom: 20px;width:100%;">
	<p>
		Thank you very much for signing up and showing interest on becoming a Hospital/Laboratory Member of MyResultOnline (MRO). The email address you have entered is your MRO-ID and login&rsquo;s username to MRO website in managing your account. To make sure that you have provided correct information and for security validation, a message was sent to your email address. Please check it now to continue the sign-up process.
	</p>
