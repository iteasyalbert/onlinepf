...
<div class="content">
	...
	<p>
		Thank you very much for signing up and showing interest on becoming a Physician Member of MyResultOnline (MRO). Your email address is your MRO-ID and login&rsquo;s username to MRO website in claiming your patients&rsquo; laboratory test results. To make sure that you have provided correct information and for security validation, a message was sent to your email address. Please check it now to continue your sign-up process.
	</p>
	<br/>
<?php
if($email):
