...
<div class="container">
		<?php echo $this->Form->create('User',array('class' => 'test-frm','enctype' => 'multipart/form-data'));?>
			...
			<div class="form-group">
				...
				<?php echo $this->Form->input('User.new_password',array('id'=>'NewPW','class'=>"form-control",'label' => false,'div' => false,'type' => 'password'));?>
			</div>
			<div class="form-group">
				<label for="ConfirmPW">Confirm Password:</label>
				<?php echo $this->Form->input('User.confirm_password',array('id'=>'ConfirmPW','class'=>"form-control",'label' => false,'div' => false,'type' => 'password' ));?>
			</div>
			<div class="form-group">
