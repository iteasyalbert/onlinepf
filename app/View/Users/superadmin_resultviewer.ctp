...
<div id="top-menu" style="height:35px;padding-left:15px;">
	<table id="common-tbl2" style="width: 40%;" >
		<tr>
			<th cospan="3">
				<a href="/superadmin/users/resultviewer_add/">Add Viewer</a>
			</th>
		</tr>
	</table>
	...
	<div id="view">
		<h2><?php echo __('Result Viewer');?></h2>
		...
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Html->link(__('Edit'), array('action' => 'resultviewer_edit','superadmin'=>true, $admin['User']['id'])); ?>
				<?php echo $this->Html->link(__('Delete'), array('superadmin'=>true,'action' => 'deleteviewer', $admin['User']['id']), null, __('Are you sure you want to delete # %s?', $admin['User']['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
		</table>
...
#top-menu table a{ background: url("/img/heartcenter/navbar2.png") repeat scroll 0 0 transparent; border-radius: 3px;
	color: #fff;display: block;position: relative;width:50%;height:20px;margin:0 3px 5px 0;line-height:31px;padding:3px 0 0 10px;text-decoration: none;
