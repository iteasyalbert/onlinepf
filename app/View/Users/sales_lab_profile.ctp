...
<div class="content">
	<div id="main-tab" class="widget-result">
			<ul class="tabnav">
				<li><a style="background: none;" href="#profile">Pending Laboratories</a></li>
            </ul>
	...
	<!--			<div id="my_map" style="border:1px solid #BFB092; width:300px;height:230px;margin-top:20px;float:right;"></div>-->
			...
			<br/>
			<?php $labClass = array(1 => 'Primary',2 => 'Secondary',3 => 'Tertiary');?>
			...
			<div style="width:48%;">
				<table id="double-td-tbl">
					...
					<tr><td><h2>PROFILE</h2></td><td></td></tr>
						...
						<tr><td><label>Corporate&nbsp;Name:</label></td><td>
							<?php echo $branch['CompanyBranch']['name'];?>
						</td></tr>
						<tr><td><label>Classification:</label></td><td>
							<?php echo (!empty($laboratory['Laboratory']['class']))?$labClass[$laboratory['Laboratory']['class']]:"";?>
						</td></tr>
						<tr><td><label>Type:</label></td><td>
							<?php echo (!empty($laboratory['Laboratory']['type']))?$labType[$laboratory['Laboratory']['type']]:"";?>
						</td></tr>
					</tbody>
				</table>
				<table id="double-td-tbl">
