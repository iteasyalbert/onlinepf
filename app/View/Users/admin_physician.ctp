	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Html->link(__('Edit'), array('action' => 'physician_edit','admin'=>true, $admin['User']['id']),array('class'=>'btn btn-success')); ?>
				<?php //echo $this->Html->link(__('Reset'), array('action' => 'resetpassword','admin'=>true, $admin['User']['id'])); ?>
				<?php echo $this->Html->link(__('Reset'), array('admin'=>true,'action' => 'resetpassword', $admin['User']['id']),array('class'=>'btn btn-success'), __('Are you sure you want to reset password # %s?', $admin['User']['id'])); ?>
