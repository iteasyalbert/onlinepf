...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete'), array('superadmin'=>true,'controller'=>'users','action' => 'deleteviewer', $value['User']['id']), null, __('Are you sure you want to delete # %s?', $value['User']['id'])); ?></li>
		<li><?php echo $this->Html->link(__('List Tags'), array('action' => 'resultviewer','superadmin'=>true));?></li>
	</ul>
</div>
<?php }?>
