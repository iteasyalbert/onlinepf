...
<?php echo $this->Form->create(null,array('enctype' => 'multipart/form-data','class'=>'lab_signup_form'));?>
	...
	<br/>
	<p>
		We are requesting that you complete your hospital/laboratory profile by filling-up the following information below. These information will help MRO in providing your hospital/laboratory quality services.
	</p>
	<br/>
			...
			<div id="profile-div">
				<div style="width:100%;">
					<table id="profile-table" class="profile-table-class" style="float:left;width:auto">
						...
						<tr class="company_name"><td><label>Company Name:</label></td><td>
						...
						<tr class="lab_name"><td><label>Laboratory&nbsp;Name:</label></td><td><?php echo $this->Form->input('CompanyBranch.name',array('label'=>false,'div'=>false));?><i><span class="span-req" >*</span></i></td></tr>
						<tr class="lab_website"><td><label>Website:</label></td><td><?php echo $this->Form->input('CompanyBranchInfo.website',array('label'=>false,'div'=>false,'maxlength'=>false));?><i><span class="span-req" >*</span></i></td></tr>
						<?php $class = array('1'=>'Hospital','2'=>'Laboratory','3'=>'Clinic');?>
						<tr class="classification"><td><label>Classification:</label></td><td><?php echo $this->Form->select('Laboratory.class',$class,array('label'=>false,'legend'=>false,'value'=>$classLaboratory,'readonly'=>'readonly'))?><i><span class="span-req" >*</span></i></td></tr>
