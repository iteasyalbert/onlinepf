...
<div class="users index">
	...
	<tr>
		...
		<td><?php echo ($admin['User']['status']==1)?'Activated':'Deactivated'; ?>&nbsp;</td>
		<td><?php echo h($admin['Person']['entry_datetime']); ?>&nbsp;</td>
		<td class="actions">
			<?php //echo $this->Html->link(__('View'), array('action' => 'view', $admin['Post']['id'])); ?>
			<?php echo $this->Html->link(__('View'), array('action' => 'patient_view', $admin['User']['id'])); ?>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Tag'), array('action' => 'administrator_add')); ?></li>
	</ul>
</div>
