			...
			<div id="profile-div">
				<div style="width:100%;">
					...
					<!-- <tr><td><label>Type:</label></td><td><?php echo $this->Form->radio('Company.comopt',array('1'=>'New','2'=>'Existing'),array('value'=>(isset($this->data['Company']['comopt']))?$this->data['Company']['comopt']:1,'legend'=>false,'class'=>'comopt'));?></td></tr> -->
						...
						<tr id="prerequisite" class="lab_name"><td><label>Laboratory&nbsp;Name:</label></td><td><?php echo $this->Form->input('CompanyBranch.name',array('label'=>false,'div'=>false));?><i><span class="span-req" >*</span></i></td></tr>
						...
						<tr id="prerequisite" class="classification"><td><label>Classification:</label></td><td><?php echo $this->Form->select('Laboratory.class',$class,array('label'=>false,'legend'=>false,'value'=>$classLaboratory,'readonly'=>'readonly'))?><i><span class="span-req" >*</span></i></td></tr>
						<tr id="prerequisite"><td><h2>Address&nbsp;Details</h2></td><td></td></tr>
