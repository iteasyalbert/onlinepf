...
<div class="users form">
	<fieldset>
		<legend><?php echo __('Admin Edit Users'); ?></legend>
				<?php echo $this->Form->create('User',array('controller'=>'User', 'action'=>'accounting_edit', 'admin'=>true));?>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Tags'), array('action' => 'accounting'));?></li>
	</ul>
</div>
<?php }?>